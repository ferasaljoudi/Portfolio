...
const experiences = [
  {
    ...
    technologies: ["Python", "C++", "Java", "Gnuplot", "Mummer", "Linux", "Git", "Data Analysis", "Sequence Comparison"]
  },
  {
    ...
    technologies: ["Microsoft Office", "Project Management", "Email Communication Platforms", "Electrical Equipment Handling"]
  },
  {
    ...
    technologies: ["Team Leadership", "Sales Analysis", "Schedule Organization", "Customer Service"]
  },
  {
    ...
    technologies: ["Project Management", "Digital Measurement", "Reporting", "Microsoft Excel"]
  }
];
